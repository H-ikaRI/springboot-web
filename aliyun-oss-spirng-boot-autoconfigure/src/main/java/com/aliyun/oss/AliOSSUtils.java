...
public class AliOSSUtils {
    ...
    public AilOSSProperties getAilOSSProperties() {
        return ailOSSProperties;
    }

    public void setAilOSSProperties(AilOSSProperties ailOSSProperties) {
        this.ailOSSProperties = ailOSSProperties;
    }
